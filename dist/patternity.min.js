...
Array.isArray||g.isArray;g.isNull=function(a){return null===a};g.isDefined=function(a){return!(g.isNull(a)||g.isUndefined(a))};var t=function(a){a=B.call(a);return a.substring(8,a.length-1)},f=function(a,b){for(var c=a.split("."),d=c.shift(),i=O;d;)i[d]||(i[d]={}),0===c.length&&b&&(i[d]=b),i=i[d],d=c.shift();return i};k=function(a){function b(){}b.prototype=a;return new b};var u=function(a,b){var c,d;if(a&&b){if(C(b)){c=0;for(d=b.length;c<d;c++)u(a,b[c])}else for(c in b)b.hasOwnProperty(c)&&(a[c]=
b[c]);return a}},D=function(a,b){var c,d;if(C(b)){c=0;for(d=b.length;c<d;c++)if(!D(a,b[c]))return!1;return!0}if(P(b)){for(d in b)if(b.hasOwnProperty(d)&&(c=a[d],Q(c)||t(c)!==t(b[d])))return!1;return!0}},h=function(a){var b,c;if(!g.isArray(this))throw new TypeError("Need an Array as scope");if(!g.isFunction(a))throw new TypeError("Need function");b=0;for(c=this.length;b<c;b++)a(this[b],b,this)},C=g.isArray,P=g.isObject,Q=g.isUndefined;e.utils=u(g,{createNS:f,extend:function(a,b){var c=function(){};
c.prototype=b.prototype;a.prototype=new c;return a},createObject:Object.create||k,forEach:Array.prototype.forEach||h,mixin:u,pairCall:function(a,b,c){var d;if(g.isFunction(a)&&g.isObject(b)){for(d in b)b.hasOwnProperty(d)&&a.call(c,d,b[d]);return!0}return!1},isImplementing:D,getType:t});e.NS=f;var R=this,n=function(a,b){var c,d;if(S(b))j.forEach.call(b,function(b){n(a,b)});else for(c in b)b.hasOwnProperty(c)&&(d=b[c],T[c]||(a[c]=d))},E=function(a,b,c){c=c||b.className;q(a)?j.createNS([a,".",c].join(""),
b):v(a)?a[c]=b:R[c]=b},F=function(a,b,c){if(!q(a))throw new TypeError("a class name is required");if(!v(b))throw new TypeError(a+": class definition must be an object");if(c&&!q(c)&&typeof c!==U)throw new TypeError(a+": package must be an object or string");},G=function(a,b,c){b=m(b)?b.prototype:b;if(!j.isImplementing(a.prototype,b))throw Error(c+" implementation for interface is missing");},r=function(a,b){for(var c in a)a.hasOwnProperty(c)&&(a[c]&&"object"===typeof a[c])&&b.push({key:c,value:a[c]})},
I=function(a){for(var b=a.length,c;b--;)c=a[b],this[c.key]=H(c.value)},f=function(a,b,c){var d,i=[],e,f,g,h;F(a,b,c);e=b.Extends;f=b.Mixin;g=b.Static;h=b.Implements;m(e)&&r(e.prototype,i);r(b,i);m(f)?r(f.prototype,i):v(f)&&r(f.prototype,i);d=i.length?m(b.initialize)?function(){i.length&&I.call(this,i);b.initialize.apply(this,arguments)}:function(){i.length&&I.call(this,i)}:b.initialize||function(){};d.nsName=q(c)?c+"."+a:a;m(e)&&(d.prototype=H(e.prototype));n(d.prototype,b);f&&(m(f)?n(d.prototype,
f.prototype):n(d.prototype,f));h&&G(d,h);g&&j.mixin(d,g);E(c,d,a);return d},T={Extends:1,Implements:1,Mixin:1,Static:1,initialize:1,className:1},U="object",j=e.utils,H=j.createObject,v=j.isObject,q=j.isString,S=j.isArray,m=j.isFunction;f.prototype={isImplementing:G,validateInput:F,mixinProto:n,applyToPackage:E};e.Class=f;var J=function(a){var b=new a;this.getInstance=function(){return b}},f=function(a,b,c){K.prototype.validateInput(a,b,c);b=new J(e.Class(a,b,{}));K.prototype.applyToPackage(c,b,a);
return b},K=e.Class;f.prototype={Singleton:J};e.Singleton=f;var M=function(a,b){var c=this;Object.keys(b).forEach(function(b){if(V(a[b]))c[b]=function(){return a[b].apply(a,arguments)};else if("undefined"!==typeof a[b])W(c,b,{set:function(c){a[b]=c},get:function(){return a[b]},enumerable:!0,writeable:!0});else throw L="cannot bind "+b+"() implementation is missing",L;})},f=function(a,b,c){function d(a){if(a&&X(a))M.call(this,a,b);else throw"an object for interface binding should be defined";}d.nsName=
Y(c)?c+"."+a:a;w.prototype.validateInput(a,b,c);d.bind=function(a){return new d(a)};d.isImplementedBy=function(a){return s.isImplementing(a,d)};w.prototype.mixinProto(d.prototype,b);w.prototype.applyToPackage(c,d,a);return d},w=e.Class,L,W=Object.defineProperty||function(){},s=e.utils,X=s.isObject,Y=s.isString,V=s.isFunction;f.prototype={bind:M};e.Interface=f;var Z=Array.prototype.slice,x=e.utils,y=x.isFunction;e.Class("Observable",{__observers:{},triggerObservers:function(a){var b=this.__observers[a],
c=0,d;if(b){c=0;for(d=b.length;c<d;c++)b[c].apply(this,arguments)}},get:function(a){return this[a]},set:function(a,b){var c;!x.pairCall(this.set,a,this)&&!y(this[a])&&(c=this[a],this[a]=b,this.triggerObservers(a,b,c))},callFunction:function(a){var b=Z.call(arguments,1),c;if(y(this[a]))return c=this[a].apply(this,b),this.triggerObservers(a,c,b),c},observe:function(a,b){var c=this.__observers;x.pairCall(this.observe,a,this)||(c[a]||(c[a]=[]),y(b)&&c[a].push(b))},removeObserver:function(a,b){var c=this.__observers[a]||
[],d;for(d=c.length;d--;)if(c[d]===b){c.splice(d,1);break}},removeObservers:function(a){var b=this.__observers;b[a]&&delete b[a]}},e);e.Interface("IIterator",{first:function(){},next:function(){},currentItem:function(){},isDone:function(){},each:function(){}},e);var z=e.utils;e.Class("Iterator",{Implements:e.IIterator,initialize:function(a){if(a instanceof Array)this.__iterable=a;else if(a&&z.isObject(a)){var b,c=[];for(b in a)a.hasOwnProperty(b)&&c.push(a[b]);this.__iterable=c}else if(a&&z.isString(a))this.__iterable=
a.split("");else throw"non iterable";this.__index=this.__currentItem=null;this.first()},first:function(){this.__index=0;return this.currentItem()},next:function(){if(!this.isDone())return this.__index++,this.currentItem()},currentItem:function(){return this.__iterable[this.__index]},isDone:function(){return this.__index===this.__iterable.length},each:function(a){var b=this.__iterable,c=[],d,e=b.length;if(z.isFunction(a))for(d=0;d<e;d++)this.__index=d,c.push(a(b[d],d,b));return c}},e);e.Class("List",
{__elements:[],add:function(a){this.__elements.push(a)},getAt:function(a){return this.__elements[a]},indexOf:function(a){for(var b=this.__elements,c=b.length;c--;)if(b[c]===a)return c;return-1},getLength:function(){return this.__elements.length},hasElement:function(a){return-1!==this.indexOf(a)},removeAt:function(a){-1<a&&this.__elements.splice(a,1)},remove:function(a){for(var b=this.indexOf(a);-1!==b;)this.removeAt(b),b=this.indexOf(a)},getElements:function(){return this.__elements},iterator:function(){return e.IIterator.bind(new e.Iterator(this.__elements))},
...
b))});return c},setAll:function(a,b){this.iterator().each(function(c){c[a]=b})}},e);var A=e.utils,p=A.isFunction,$=A.isObject;e.Class("Listenable",{__registry:{},addListener:function(a,b){var c=this.__registry;if(!A.pairCall(this.addListener,a,this))if(b&&(p(b)||$(b)))c[a]||(c[a]=[]),c[a].push(b);else throw"listener has to be a function or an object";},on:function(){this.addListener.apply(this,arguments)},once:function(a,b){function c(){p(b)?b.apply(d,arguments):p(b[a])&&b[a].apply(d,arguments);d.removeListener(a,
